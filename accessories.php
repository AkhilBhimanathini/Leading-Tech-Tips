...
<div class="super_container">
	...
	<div class="home">
		<div class="home_background parallax-window" data-parallax="scroll" data-image-src="images/category.jpg" data-speed="0.8">
		</div>
			...
			<div class="row row-lg-eq-height">
				...
				<div class="col-lg-9">
					<div class="main_content">
    					...
    					?>
						<div class="category"><h1 style="color: black">Accessories <?php echo "->"; echo ucwords($cat_title);  ?></h1>
						<?php } 
						else{
							?>
							<div class="category"><h1 style="color: black">Accessories </h1>
							<?php	
						}
						?>
							...
							<div class="section_content">
								<div class="grid clearfix">
									...
									if(isset($_GET['cat_id'])){
									$cat_id = $_GET['cat_id'];
									    $get_post = "select * from post where p_cat_id= 5 and cat_id=$cat_id order by post_id DESC ";
								...
								?>
									...
									<?php
									if(!isset($_GET['cat_id'])){
									    $get_post = "select * from post where p_cat_id= 5 order by post_id DESC ";
								...
								?>
									...
									<?php
									    $get_post = "select * from post order by post_id DESC Limit 5,10";
