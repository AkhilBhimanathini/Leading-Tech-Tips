...
<div class="super_container">
	...
	<div class="home">
		<div class="home_background parallax-window" data-parallax="scroll" data-image-src="images/howto.jpg" data-speed="0.8">
		</div>
			...
			<div class="row row-lg-eq-height">
				...
				<div class="col-lg-9">
					<div class="main_content">
						...
						<div class="category"><h1 style="color: black">HowTo</h1>
							...
							<div class="section_content">
								<div class="grid clearfix">
									...
									<?php
									    $get_post = "select * from post where p_cat_id= 2 order by post_id DESC ";
