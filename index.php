					...
					<div class="header_content d-flex flex-row align-items-center justify-content-start">
						...
						<div class="search_container ml-auto">
							...
							<form id="searchForm" class="form-inline p-3">
								...
								<input type="submit" id="submit"  class="btn btn-info btn-lg rounded-0" height="20px" width="10%">
								<img class="header_search_icon" src="images/search.png" alt="">
								<div id="output"></div>
							</form>
						</div>
							...
							<div class="section_content">
								<div class="grid clearfix">
									...
									<div class="card card_largest_with_image grid-item">
										<img class="card-img-top" src="<?php echo $mini_slider_img; ?>" alt="https://unsplash.com/@cjtagupa">
										<div class="card-body">
