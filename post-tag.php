...
<?php
  ...
  $sql = "select * from post where post_tag='".$post_tag."' ";
...
<html lang="en">
<head>
<title>LTT | <?php echo $post_tag; ?></title>
<?php
}
}
?>
				...
				<div class="col-lg-9">
					<div class="main_content">
						...
						<?php } 
							...
							?>
							<div class="category"><h1 style="color: black"><?php echo"@ $post_tag";?></h1>
							<?php	
						}
						?>
							...
							<div class="section_content">
								<div class="grid clearfix">
									...
									if(isset($_GET['post_tag'])){
									$post_tag = $_GET['post_tag'];
									    $get_post = "select * from post where post_tag='".$post_tag."' ";
